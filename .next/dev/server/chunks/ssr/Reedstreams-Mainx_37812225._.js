...
const pageStyles = `
  ...
  .layout-cinema {
    ...
    max-width: 1200px; /* Cinema mode focus */
  }
  ...
  @media (max-width: 1024px) {
    .match-grid {
      ...
      padding: 0; /* Remove padding to go edge-to-edge on mobile */
      gap: 0;
    }
    ...
    /* Player goes full width on mobile */
    .player-wrapper {
      width: 100vw; 
      max-width: 100%;
    }

    /* Controls padding fix */
    .controls-bar, .match-main-title {
      padding-left: 15px;
      padding-right: 15px;
    }
    ...
    .chat-panel {
      height: 500px;
      margin-top: 10px;
      border-radius: 0; /* Full width chat */
      border-left: none;
      border-right: none;
    }
  }
...
function MatchPageContent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Reedstreams$2d$Mainx$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Try to get match data from session storage to avoid a flicker
        const stored = sessionStorage.getItem("currentMatch");
        if (stored) {
            try {
                const data = JSON.parse(stored);
                // Prefer Title, then Competition, then Names
...
//# sourceMappingURL=Reedstreams-Mainx_37812225._.js.map