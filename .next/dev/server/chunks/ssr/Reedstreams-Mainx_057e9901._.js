...
const pageStyles = `
  ...
  .layout-cinema .player-wrapper {
    box-shadow: 0 0 50px rgba(0,0,0,0.8); /* Deeper shadow */
    margin-bottom: 20px;
  }

  /* INFO BAR (Title + Controls) */
  .info-bar {
    margin-top: 15px;
    display: flex;
    justify-content: space-between;
...
function MatchPageContent() {
    ...
    const [showEmbed, setShowEmbed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Reedstreams$2d$Mainx$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true) // 🔥 DEFAULT OPEN
    ;
...
//# sourceMappingURL=Reedstreams-Mainx_057e9901._.js.map