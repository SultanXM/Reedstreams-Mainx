            ...
            async function fetchMatchData() {
                try {
                    ...
                    const match = matches.find({
                        "MatchPlayerPage.useEffect.fetchMatchData.match": (m)=>String(m.id) === String(matchId)
                    }["MatchPlayerPage.useEffect.fetchMatchData.match"]);
                    if (match) {
                        setMatchData(match);
...
_s(MatchPlayerPage, "WSeXKoAAdtW1VAMS+vSA8hIz0oU=", false, function() {
    return [
...
_c = MatchPlayerPage;
var _c;
__turbopack_context__.k.register(_c, "MatchPlayerPage");
...
//# sourceMappingURL=_b2689830._.js.map