...
function Header() {
    ...
    // Fix Hydration Error by only rendering interactive components on client
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            isMounted ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenu"], {
                                ...
                                lineNumber: 68,
                                columnNumber: 13
                            }, this) : // Placeholder button to prevent layout shift while loading
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                className: "boxed-btn",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$globe$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Globe$3e$__["Globe"], {
                                    width: 18
...
"[project]/components/layout/Floatingimp.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/sports/Sportsgrid.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SportsGrid() {
    ...
    const [apiError, setApiError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false) // Toast State
    ;
        ...
        "SportsGrid.useEffect": ()=>{
            async function loadSports() {
                try {
                    ...
                    let sportsData = await res.json();
                    sportsData = sortSportsList(sportsData);
                    const sportsWithCounts = await Promise.all(sportsData.map({
                        "SportsGrid.useEffect.loadSports": async (sport)=>{
                            try {
                                const matchesRes = await fetch(`${STREAMED_API_BASE}/matches/${sport.id}`);
                                ...
                                const liveMatches = Array.isArray(matches) ? matches.filter({
                                    "SportsGrid.useEffect.loadSports": (m)=>m.sources?.length > 0 && hasMatchStarted(m.date)
                                }["SportsGrid.useEffect.loadSports"]) : [];
                                return {
                                    ...sport,
                    ...
                    const fallbackWithCounts = sortedFallback.map({
                        "SportsGrid.useEffect.loadSports.fallbackWithCounts": (sport)=>({
                                ...sport,
                                matchCount: 0
                            })
                    }["SportsGrid.useEffect.loadSports.fallbackWithCounts"]);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: "Click on the sports to stream it should be working."
                            }, void 0, false, {
                                fileName: "[project]/components/sports/Sportsgrid.tsx",
                                lineNumber: 237,
                                columnNumber: 11
...
_s(SportsGrid, "z5R9GGLs+oh7c4Ra2tfUhe7mp9s=");
_c = SportsGrid;
var _c;
...
"[project]/components/home/LiveSchedule.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* components/home/LiveSchedule.tsx */ __turbopack_context__.s([
    "default",
    ()=>LiveSchedule
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
...
const GRADIENT_CLASSES = Array.from({
    length: TOTAL_GRADIENTS
}, (_, i)=>`gradient-type-${i + 1}`);
...
/** NEW: Formats the date for display (e.g., Dec 07) */ function formatDate(timestamp) {
    const date = new Date(timestamp);
...
function LiveSchedule() {
            ...
            async function fetchData() {
                try {
                    ...
                    const filteredMatches = allMatches.filter({
                        "LiveSchedule.useEffect.fetchData.filteredMatches": (match)=>isMatchToday(match.date)
                    }["LiveSchedule.useEffect.fetchData.filteredMatches"]);
                    const groupedMatches = {};
                    filteredMatches.forEach({
                        "LiveSchedule.useEffect.fetchData": (match)=>{
                    ...
                    }["LiveSchedule.useEffect.fetchData"]);
                    // Sort each group: LIVE (Active) matches first, then chronological
                    Object.keys(groupedMatches).forEach({
                        "LiveSchedule.useEffect.fetchData": (category)=>{
                            groupedMatches[category].sort({
                                "LiveSchedule.useEffect.fetchData": (a, b)=>{
    ...
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "text-center p-10 py-20 text-[#555]",
        children: "Loading Today's Schedule..."
    }, void 0, false, {
        fileName: "[project]/components/home/LiveSchedule.tsx",
        lineNumber: 115,
        columnNumber: 23
    }, this);
    if (Object.keys(schedule).length === 0) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "text-center p-10 py-20 text-[#555]",
            children: "No streamable matches scheduled for today."
        }, void 0, false, {
            fileName: "[project]/components/home/LiveSchedule.tsx",
            lineNumber: 118,
            columnNumber: 12
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        className: "schedule-section-grouped",
        children: Object.entries(schedule).map(([sportCategory, matches])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "sport-group",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        className: "sport-group-header-grid",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: matches.map((match, index)=>{
                            ...
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: `match-grid-card ${gradientClass}`,
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "card-content-overlay",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "card-logos-center",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                        src: getBadgeUrl(homeTeamBadge),
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        style: {
                                                            backgroundColor: active ? '#8db902' : '#2a2e38',
...
_s(LiveSchedule, "b23s22DK3FdIMYTvANEkyxHTSXs=");
_c = LiveSchedule;
var _c;
__turbopack_context__.k.register(_c, "LiveSchedule");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=components_94458360._.js.map