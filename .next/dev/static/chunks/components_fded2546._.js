                ...
                try {
                    ...
                    const sportsWithCounts = sportsData.map({
                        "SportsGrid.useEffect.fetchData.sportsWithCounts": (sport)=>{
                            ...
                            }["SportsGrid.useEffect.fetchData.sportsWithCounts.sportMatches"]);
                            const activeCount = sportMatches.filter({
                                "SportsGrid.useEffect.fetchData.sportsWithCounts": (m)=>isCurrentlyActive(m.date)
                            }["SportsGrid.useEffect.fetchData.sportsWithCounts"]).length;
                            return {
                                ...sport,
                                matchCount: activeCount
                            };
                        }
                    }["SportsGrid.useEffect.fetchData.sportsWithCounts"]);
                    ...
                    const fallbackWithCounts = sortedFallback.map({
                        "SportsGrid.useEffect.fetchData.fallbackWithCounts": (sport)=>({
                                ...sport,
                                matchCount: 0
                            })
                    }["SportsGrid.useEffect.fetchData.fallbackWithCounts"]);
...
__turbopack_context__.k.register(_c1, "SportsGrid");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/home/MatchesCarousel.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(MatchesCarousel, "5okL0DAk6Atnb3+Rru+wGBWyP+4=");
_c = MatchesCarousel;
var _c;
__turbopack_context__.k.register(_c, "MatchesCarousel");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=components_fded2546._.js.map